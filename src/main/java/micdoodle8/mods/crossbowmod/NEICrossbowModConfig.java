...
public class NEICrossbowModConfig implements IConfigureNEI
{
    ...
    public void registerRecipes()
    {
        for (Entry<CrossbowInfo, ItemStack> recipe : CrossbowRecipes.getRecipeMap().entrySet())
        {
            ...
            {
            case wooden:
                limbStack = new ItemStack(Items.attachmentLimbBolt, 1, 5);
                break;
            case stone:
                limbStack = new ItemStack(Items.attachmentLimbBolt, 1, 6);
                break;
            case iron:
                limbStack = new ItemStack(Items.attachmentLimbBolt, 1, 7);
                break;
            case gold:
                limbStack = new ItemStack(Items.attachmentLimbBolt, 1, 8);
                break;
            case diamond:
                limbStack = new ItemStack(Items.attachmentLimbBolt, 1, 9);
                break;
            default:
                limbStack = null;
                continue;
            ...
            {
            case none:
                mechanism = new ItemStack(Items.attachmentLimbBolt, 1, 10);
                break;
            case light:
                mechanism = new ItemStack(Items.attachmentLimbBolt, 1, 11);
                break;
            case medium:
                mechanism = new ItemStack(Items.attachmentLimbBolt, 1, 12);
                break;
            case heavy:
                mechanism = new ItemStack(Items.attachmentLimbBolt, 1, 13);
                break;
            case tri:
                mechanism = new ItemStack(Items.attachmentLimbBolt, 1, 23);
                break;
            default:
                mechanism = null;
                continue;
            ...
            case none:
                ...
                break;
            case shortscope:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 14);
                break;
            case longscope:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 15);
                break;
            case flame:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 16);
                break;
            case explosive:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 17);
                break;
            case lava:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 18);
                break;
            case ice:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 19);
                break;
            case lightning:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 20);
                break;
            case torch:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 21);
                break;
            case poison:
                attachment = new ItemStack(Items.attachmentLimbBolt, 1, 22);
                break;
            default:
                attachment = null;
                continue;
