...
public class ConfigManager 
{
	...
	private void setDefaultValues()
    {
		try
		{
	        ...
	        idItemStoneBolt = 											configuration.get(Configuration.CATEGORY_ITEM, 					"StoneBolt", 										11084).getInt(11084);
	        ...
	        idItemIronBolt = 											configuration.get(Configuration.CATEGORY_ITEM, 					"IronBolt", 										11125).getInt(11125);
	        ...
	        idItemGoldBolt = 											configuration.get(Configuration.CATEGORY_ITEM, 					"GoldBolt", 										11166).getInt(11166);
	        ...
	        idItemDiamondBolt = 										configuration.get(Configuration.CATEGORY_ITEM, 					"DiamondBolt", 										11207).getInt(11207);

	        idBlockCrossbowBench = 										configuration.get(Configuration.CATEGORY_BLOCK, 				"BlockCrossbowBench", 								1999).getInt(1999);

	        idItemWoodLimb = 											configuration.get(Configuration.CATEGORY_ITEM,	 				"WoodLimb", 										11208).getInt(11208);
	        idItemStoneLimb = 											configuration.get(Configuration.CATEGORY_ITEM,	 				"StoneLimb", 										11209).getInt(11209);
	        idItemIronLimb = 											configuration.get(Configuration.CATEGORY_ITEM,	 				"IronLimb", 										11210).getInt(11210);
	        idItemGoldLimb = 											configuration.get(Configuration.CATEGORY_ITEM,	 				"GoldLimb", 										11211).getInt(11211);
	        idItemDiamondLimb = 										configuration.get(Configuration.CATEGORY_ITEM,	 				"DiamondLimb", 										11212).getInt(11212);

	        idItemSemiAutoMechanism = 									configuration.get(Configuration.CATEGORY_ITEM,	 				"SemiAutoMechanism", 								11213).getInt(11213);
	        idItemLightAutoMechanism = 									configuration.get(Configuration.CATEGORY_ITEM,	 				"LightAutoMechanism", 								11214).getInt(11214);
	        idItemMediumAutoMechanism = 								configuration.get(Configuration.CATEGORY_ITEM,	 				"MediumAutoMechanism", 								11215).getInt(11215);
	        idItemHeavyAutoMechanism = 									configuration.get(Configuration.CATEGORY_ITEM,	 				"HeavyAutoMechanism", 								11216).getInt(11216);

	        idItemBasicScope = 											configuration.get(Configuration.CATEGORY_ITEM,	 				"BasicScope", 										11217).getInt(11217);
	        idItemLongRangeScope = 										configuration.get(Configuration.CATEGORY_ITEM,	 				"LongRangeScope", 									11218).getInt(11218);
	        idItemFlameAttachment = 									configuration.get(Configuration.CATEGORY_ITEM,	 				"FlameAttachment", 									11219).getInt(11219);
	        idItemExplosiveAttachment = 								configuration.get(Configuration.CATEGORY_ITEM,	 				"ExplosiveAttachment", 								11220).getInt(11220);
	        idItemLavaAttachment = 										configuration.get(Configuration.CATEGORY_ITEM,	 				"LavaAttachment", 									11221).getInt(11221);
	        idItemIceAttachment = 										configuration.get(Configuration.CATEGORY_ITEM,	 				"FrostAttachment", 									11222).getInt(11222);
	        idItemLightningAttachment = 								configuration.get(Configuration.CATEGORY_ITEM,	 				"LightningAttachment", 								11223).getInt(11223);
	        idItemTorchAttachment = 									configuration.get(Configuration.CATEGORY_ITEM,	 				"TorchAttachment", 									11224).getInt(11224);
	        idItemPoisonAttachment = 									configuration.get(Configuration.CATEGORY_ITEM,	 				"PoisonAttachment", 								11225).getInt(11225);
