...
public class RenderDiamondBolt extends Render
{
    ...
    public void renderArrow(EntityDiamondBolt entitydiamondbolt, double d, double d1, double d2, float f, float f1)
    {
        ...
        loadTexture("/Mic'sMods/CrossbowMod/items/diamondbolt.png");
        GL11.glPushMatrix();
        ...
        float f11 = (float) entitydiamondbolt.arrowShake - f1;
    ...
    {
        renderArrow((EntityDiamondBolt)entity, d, d1, d2, f, f1);
    }
}
