...
public class ExplosionCrossbow extends Explosion
{
    ...
    public ExplosionCrossbow(World par1World, Entity par2Entity, EntityPlayer player, double par3, double par5, double par7, float par9)
    {
        ...
        for (int var11 = 0; var11 < var9.size(); ++var11)
        {
            ...
            if (var13 <= 1.0D)
            {
                ...
                if (var34 != 0.0D)
                {
                    ...
                    var32.attackEntityFrom(DamageSourceCrossbow.causePlayerDamage((EntityBolt)exploder, player), (int)((var35 * var35 + var35) / 2.0D * 8.0D * (double)this.explosionSize + 1.0D));
