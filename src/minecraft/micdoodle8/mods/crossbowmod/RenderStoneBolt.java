...
public class RenderStoneBolt extends Render
{
    ...
    public void renderArrow(EntityStoneBolt entitystonebolt, double d, double d1, double d2, float f, float f1)
    {
        ...
        loadTexture("/Mic'sMods/CrossbowMod/items/stonebolt.png");
        GL11.glPushMatrix();
        ...
        float f11 = (float) entitystonebolt.arrowShake - f1;
    ...
    {
        renderArrow((EntityStoneBolt)entity, d, d1, d2, f, f1);
    }
}
