...
public class Util
{
	...
	public static void addRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(Items.attachmentLimbBolt, 1, 20), new Object[] {
			...
			"ZRZ",
			"ZZG",
			Character.valueOf('G'), Item.glowstone, Character.valueOf('Z'), Item.ingotIron, Character.valueOf('R'), Item.redstone
		});
...
//    {
//    	ExplosionCrossbow var11 = new Explosion(par1Entity.worldObj, par1Entity, player, par2, par4, par6, par8);
